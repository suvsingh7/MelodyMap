...
const Sidebar = () => {
  return (
    <div className='bg-[#301159] min-h-screen pl-[4vw]'>
        <img src={assets.Melody_logo} alt="" className="mt-5 w-[max(10vw,40px)] hidden sm:block" />
        <img src={assets.Melody_logo_4} alt="" className="mt-5 w-[max(5vw,40px)] mr-5 sm:hidden block" />
